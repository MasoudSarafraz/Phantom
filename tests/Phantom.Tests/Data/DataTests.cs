...
public class PagedTestProductSpec : QuerySpecification<TestProduct>
{
    public PagedTestProductSpec(int skip, int take)
    {
        ApplyPaging(skip, take);
    }

    public override bool IsSatisfiedBy(TestProduct candidate) => true;
...
public class RepositoryTests
{
    ...
    public void IReadRepository_Should_Not_Expose_Mutations()
    {
        ...
        Assert.DoesNotContain(methods, m => m.Name == "RemoveAsync");
        Assert.DoesNotContain(methods, m => m.Name == "GetAllAsync");
    }
    ...
    public void IWriteRepository_Should_Not_Expose_Queries()
    {
        ...
        Assert.DoesNotContain(methods, m => m.Name == "FindAsync");
        Assert.DoesNotContain(methods, m => m.Name == "CountAsync");
    }
    ...
    public async Task GetPagedAsync_Should_Return_Paged_Results()
    {
        ...
        var page = await repo.FindAsync(new PagedTestProductSpec(skip: 5, take: 3));
